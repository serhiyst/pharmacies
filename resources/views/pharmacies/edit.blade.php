...
<form class="container" method="POST" action="/pharmacies/{{ $pharmacy->id }}">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="legal_entity" value="{{ $pharmacy->legal_entity }}" required>
  </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" name="city" value="{{ $pharmacy->city }}" required>
    </div>
    <div class="form-group col-md-4">
      <label for="district">Район</label>
      <input type="text" class="form-control" name="district" value="{{ $pharmacy->district }}" required>
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-2">
      ...
      <select class="form-control" name="day_of_order" value="{{ $pharmacy->day_of_order }}" required>
        <option></option>
    ...
    <div class="form-group col-md-2">
      ...
      <select class="form-control" name="day_of_delivery" value="{{ $pharmacy->day_of_delivery }}" required>
        <option></option>
    ...
    <div class="form-group col-md-1">
      ...
      <select class="form-control" name="category" value="{{ $pharmacy->category }}" required>
        <option></option>
    ...
    <div class="form-group col-md-3">
      ...
      <select class="form-control" name="sales_rep" value="{{ $pharmacy->sales_rep }}" required>
        <option></option>
